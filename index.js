  ...
  function drawControlledSineWave() {
    ...
    for (let x = 0; x < canvas.width; x += fontSize) {
      ...
      const characterIndex = Math.floor(
        ((y - z) / amplitude) * characters.length
      );
    ...
    time += 0.04; // Adjust the speed of the animation
  }
